      ...
      <main class="dashboard-page__main">
          ...
          <div class="dashboard-page__header-right">
            <div class="dashboard-page__user-info">
              <div class="user-text">
                ...
                <span class="user-status">已登录 {{ formatLoginTime }}</span>
              </div>
        ...
        <div class="dashboard-page__actions">
          <div class="dashboard-page__actions-right">
            <a href="https://github.com/yourusername/AuroraTimer" target="_blank" class="action-btn action-btn--primary action-btn--sm">
